...
- Allowed misaligned addresses
- jalr is supposed to clear its lsb
- multi-cycle stalls can not rely on imem value remaining constant
- improper register writes during interrupts

### StoatMCU:

- register forwarding bugs
- stall drops memory transactions
- use after load hazard between memory transactions
- PC misalignment after control hazard
